...
{(() => {
        ...
        <div className="mt-12 bg-gradient-to-r from-primary-600 to-primary-700 dark:from-primary-700 dark:to-primary-800 rounded-2xl p-8 text-center shadow-xl">
          ...
          <h3 className="text-2xl font-bold text-white mb-3">Join Communities on the Go</h3>
          <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
            Download the IndulgeOut app to discover and join communities easily, chat with members, and stay connected!
          </p>
