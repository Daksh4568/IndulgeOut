      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          {formData.campaignObjective && (
            <FieldReviewCard
              fieldName="Campaign Objective"
              originalValue={formData.campaignObjective}
              proposedLabel="BRAND PROPOSED"
              onResponseChange={(response) => handleFieldResponseChange('campaignObjective', response)}
            />
          )}
        ...
        <div className="mb-8">
          ...
          {formData.sponsorshipAmount && (
            <FieldReviewCard
              ...
              originalValue={formData.sponsorshipAmount}
              proposedLabel="BRAND OFFERED"
              onResponseChange={(response) => handleFieldResponseChange('sponsorshipAmount', response)}
            />
          )}

          {formData.productSamples && (
            <FieldReviewCard
              fieldName="Product Samples / Merchandise"
              originalValue={formData.productSamples}
              proposedLabel="BRAND OFFERED"
              allowModify={false}
              onResponseChange={(response) => handleFieldResponseChange('productSamples', response)}
            />
          )}

          {formData.marketingSupport && (
            <FieldReviewCard
              fieldName="Marketing Support"
              originalValue={formData.marketingSupport}
              proposedLabel="BRAND OFFERED"
              allowModify={false}
              onResponseChange={(response) => handleFieldResponseChange('marketingSupport', response)}
            />
          )}

          {formData.eventPresence && (
            <FieldReviewCard
              fieldName="On-Ground Event Presence"
              originalValue={formData.eventPresence}
              proposedLabel="BRAND OFFERED"
              allowModify={false}
              onResponseChange={(response) => handleFieldResponseChange('eventPresence', response)}
            />
          )}
        </div>

        {/* Section 3: Community Deliverables */}
        <div className="mb-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Confirm what community will deliver to brand</p>
            </div>
          </div>
