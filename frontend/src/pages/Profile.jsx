...
import { 
  ...
  Home, Settings, LogOut, CreditCard, Lock, Upload, Trash2
} from 'lucide-react'
...
const Profile = () => {
  ...
  const { user, logout, refreshUser, isAuthenticated, isHostPartner, isCommunityOrganizer, isVenue, isBrandSponsor } = useAuth()
